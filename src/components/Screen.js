...
const Screen = props => {
  ...
  return (
    <div className='screen flex-col-flx-strt-cntr'>
      <div className='title-bar flex-col-cntr-cntr'>
        <div className='title flex-row-cntr-cntr'>{props.currentTitle}</div>
        <div className='title-display flex-row-flx-end-cntr'>
          {props.display}
        </div>
      </div>
      <div className='value-section flex-col-spc-evn-cntr'>
        {props.values
          ...
          .map((val, i) => {
            return (
              ...
              >
                ...
                <div className='value-letter flex-col-cntr-cntr'>
                  {'(' + props.letterMap[val] + ')'}
                </div>
              </div>
            )
        ...
        {props.resetButton ? (
          <div
            className='reset-button flex-col-cntr-cntr'
